...
date: "2022-09-24"
description: |
  It is a simple introduction about how to use Python. This in from the summer course I participated in Barcelona School of Economics.
excerpt: null
...
There are different styles to writing code, but try to stick consistently to a (sensible) style guide: it is essential that the code not only works but is also understandable by everyone. The "official" guide for `python` can be founded here:
...
```
    ...
    <li><a class="external text" href="https://ja.wikipedia.org/wiki/"><span class="autonym" lang="ja" title="Japanese (ja:)">日本�?</span></a></li>
    ...
    <li><a class="external text" href="https://ko.wikipedia.org/wiki/"><span class="autonym" lang="ko" title="Korean (ko:)">한국�?</span></a></li>
    ...
    <li><a class="external text" href="https://bn.wikipedia.org/wiki/"><span class="autonym" lang="bn" title="Bangla (bn:)">বাংল�?</span></a></li>
    ...
    <li><a class="external text" href="https://th.wikipedia.org/wiki/"><span class="autonym" lang="th" title="Thai (th:)">ไท�?</span></a></li>
    </ul>
    </li>
    </ul>
    </div></div>
